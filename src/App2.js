...
function Ball() {
  ...
  const onCollisionEnter = () => (ref.current.setTranslation({ x: -4, y: 0, z: 0 }), ref.current.setLinvel({ x: 0, y: 10, z: 0 }))
  return (
    <>
      <RigidBody ref={ref} colliders="ball" type="fixed" mass={0} position={[-9,0,0]} linearVelocity={[1,0,0]}>
        <mesh>
